...
const Navbar = () => {
  ...
  return (
    <nav className='flex justify-around py-2 bg-slate-400 items-center shadow-lg'>
        <div>
        ...
        <div className='absolute -top-1  -right-5 text-white bg-green-600 rounded-full px-2 text-[12px] animate-bounce'>{favourite.length}</div></NavLink>
        </div>
